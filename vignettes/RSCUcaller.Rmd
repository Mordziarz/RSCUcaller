...
![Heatmap](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_heatmap.png")
...
```
![Dendogram](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_tree.png")
...
![Histogram](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_histogram.png")
...
![Histogram double](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_double_histogram.png")
...
![Correlation](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_correlation.png")
...
```
![Boxplots](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/aaa.png")
...
![PR2_plot](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_PR2.png")
...
![neutrality_plot](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_neutrality.png")
...
![PCA](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_PCA.png")
...
```
![Boxplots](file="https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ala.png")
...
# Support
Any issues connected with the RSCUcaller should be addressed to Mateusz Mazdziarz (mazdziarzm@gmail.com).
