...
![Heatmap](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_heatmap.png)
...
```
![Dendogram](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_tree.png)
...
![Histogram](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_histogram.png)
...
![Histogram double](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_double_histogram.png)
...
![Correlation](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_correlation.png)
...
```
![Boxplots](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/aaa.png)
...
![PR2_plot](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_PR2.png)
...
![neutrality_plot](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_neutrality.png)
...
![PCA](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ex_PCA.png)
...
```
![Boxplots](https://github.com/Mordziarz/RSCUcaller/blob/main/graphs/Ala.png)
